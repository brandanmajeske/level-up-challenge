...
echo form_open('password_reset/authenticate_user');
if($validated === FALSE && $validated !== NULL){
	echo '<div class="alert alert-danger">Your Username, Email or Secret Phrase failed to validate, please try again.</div>';
}
echo <<<EOT
<fieldset>
...
<label>Username
EOT;
echo '<input class="form-control input-lg" type="text" name="username" required value="'.set_value('username').'"/></label>';
echo <<<EOT
</div>
<div class="form-group">
<label>Email Address
...
echo <<<EOT
<div class="alert alert-success">Congratulations! Your identity has been verfied. Please reset your password.</div>
<fieldset>
<div class="form-group">
<label>New Password
EOT;
